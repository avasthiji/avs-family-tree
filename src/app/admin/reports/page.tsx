...
`;
  ...
  const matrimonyRate = stats.approvedUsers > 0 
          ...
          <Card className="avs-card border-0 shadow-lg">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge className="bg-green-100 text-green-800">{approvalRate}%</Badge>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="avs-card border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>Current user approval status</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                      ...
                      <span className="text-2xl font-bold text-green-600">{stats.approvedUsers}</span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                      ...
                      <span className="text-2xl font-bold text-yellow-600">{stats.pendingUsers}</span>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="text-2xl font-bold text-blue-600">{stats.maleUsers}</span>
                        <p className="text-xs text-gray-500">
                          {stats.totalUsers > 0 ? ((stats.maleUsers / stats.totalUsers) * 100).toFixed(1) : 0}%
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-pink-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="text-2xl font-bold text-pink-600">{stats.femaleUsers}</span>
                        <p className="text-xs text-gray-500">
                          {stats.totalUsers > 0 ? ((stats.femaleUsers / stats.totalUsers) * 100).toFixed(1) : 0}%
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <TabsContent value="demographics">
            <Card className="avs-card border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>Distribution by location and community details</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-sm">
                    Detailed demographic breakdowns by Gothiram, Native Place, and City
                  </p>
          ...
          {MATRIMONIAL_ENABLED && (
              ...
              <Card className="avs-card border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Male Profiles</p>
              ...
              <Card className="avs-card border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Female Profiles</p>
            ...
            <Card className="avs-card border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>Insights into matrimony profile activity</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
                    <div>
                      <p className="font-medium text-gray-900">Activation Rate</p>
                      <p className="text-sm text-gray-600">
                        Percentage of approved users with active matrimony profiles
                      </p>
                    </div>
                    <span className="text-3xl font-bold text-[#7209B7]">{matrimonyRate}%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Family Connections</p>
                        <p className="text-sm text-gray-600">Total relationships mapped</p>
                      </div>
                    </div>
                    <span className="text-3xl font-bold text-blue-600">{stats.totalRelationships}</span>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    <div className="p-4 border border-gray-200 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <p className="font-medium text-gray-900">Registration Trend</p>
                      </div>
                      <p className="text-sm text-gray-600">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-sm text-gray-700">
                  <strong>{stats.totalUsers} total users</strong> registered in the AVS Family Tree system
                </p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-[#2A9D8F] rounded-full mt-2 mr-3"></div>
                <p className="text-sm text-gray-700">
                  <strong>{approvalRate}% approval rate</strong> with {stats.approvedUsers} approved members actively participating
                </p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-[#7209B7] rounded-full mt-2 mr-3"></div>
                <p className="text-sm text-gray-700">
                  <strong>{stats.activeMatrimony} matrimony profiles</strong> ({matrimonyRate}% of approved users) seeking matches
                </p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-[#4361EE] rounded-full mt-2 mr-3"></div>
                <p className="text-sm text-gray-700">
                  <strong>{stats.totalRelationships} family relationships</strong> mapped, building a comprehensive family tree
                </p>
              </div>
            </div>
          </CardContent>
