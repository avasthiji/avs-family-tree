  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F9FA] via-white to-[#F8F9FA]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-4">அகில இந்திய வேளாளர் சங்கம்</p>
              <p className="text-lg text-gray-500 max-w-3xl mx-auto leading-relaxed">
                Connect with your roots, discover your heritage, and build lasting relationships 
                within the AVS community. Preserve your family legacy for future generations.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link href="/auth/register">
                <Button size="lg" className="avs-button-primary text-lg px-8 py-4">
                  Join Our Community
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/about/history">
                <Button size="lg" variant="outline" className="border-2 border-[#2A9D8F] text-[#2A9D8F] hover:bg-[#2A9D8F] hover:text-white text-lg px-8 py-4">
                  Learn More
                </Button>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-[#2A9D8F] mb-2">2,500+</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the powerful tools that help you connect, explore, and preserve your family heritage
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="avs-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-4 text-gray-900">Family Tree Creation</h3>
                <p className="text-gray-600 leading-relaxed">
                  Build and visualize your family tree with our intuitive tools. Connect generations and preserve your lineage.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="avs-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Preserve and celebrate AVS traditions, customs, and cultural heritage for future generations.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="avs-card border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Join events, connect with relatives, and be part of the vibrant AVS community worldwide.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#F8F9FA] to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose AVS Family Tree?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're more than just a family tree platform - we're your gateway to the AVS community
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-gray-900">Trusted & Secure</h3>
              <p className="text-gray-600 leading-relaxed">
                Your data is protected with enterprise-grade security. Admin-approved members ensure a safe community.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-gray-900">Authentic Heritage</h3>
              <p className="text-gray-600 leading-relaxed">
                Connect with verified family members and discover your authentic AVS heritage and traditions.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-gray-900">Verified Matches</h3>
              <p className="text-gray-600 leading-relaxed">
                Our matchmaking service connects you with verified, compatible matches within the AVS community.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#E63946] to-[#F77F00]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Start your journey today and discover the connections that matter most. 
            Your family tree awaits, and so does your future within the AVS community.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/register">
              <Button size="lg" className="bg-white text-[#E63946] hover:bg-gray-100 text-lg px-8 py-4">
                Get Started Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/contact">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#E63946] text-lg px-8 py-4">
                Contact Us
              </Button>
            </Link>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Connecting AVS families worldwide, preserving heritage, and building lasting relationships.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.youtube.com/@USAAVS" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 AVS Family Tree. All rights reserved. அகில இந்திய வேளாளர் சங்கம்</p>
          </div>
        </div>
      </footer>
    </div>
