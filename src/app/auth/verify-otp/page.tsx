...
function VerifyOTPPageContent() {
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    if (!userId || !identifier || !type) {
      setError(
        "Missing verification parameters. Please try registering again."
      );
      return;
    }
      ...
      if (data.autoLogin && data.user) {
        ...
        const tempPassword =
          typeof window !== "undefined"
            ? sessionStorage.getItem("temp_login_pass")
            : null;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#E63946] via-[#F77F00] to-[#E63946] relative overflow-hidden">
          ...
          {/* Content */}
          <div className="relative z-10 flex flex-col justify-center items-center text-white p-12 mx-auto">
            {/* Logo */}
            <div className="mb-8">
            ...
            <div className="space-y-6 w-full max-w-md">
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Complete verification and start connecting
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Connect with AVS families worldwide
                  </p>
                </div>
              </div>
            </div>
