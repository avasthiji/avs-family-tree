...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/auth/verify-otp?userId=${data.userId}&identifier=${data.identifier}&type=${data.type}`);
      }, 2000);
            ...
            <div className="space-y-6 w-full max-w-md">
              <div className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Connect with AVS families across the globe</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Document your family history for future generations</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Discover relatives and strengthen family bonds</p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full max-w-md">
            ...
            <Card className="avs-card border-0 shadow-2xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl font-bold avs-text-gradient">Join AVS Family Tree</CardTitle>
                <CardDescription>
              ...
              >
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <Link href="/auth/login" className="text-[#E63946] hover:underline font-medium">
                      Sign in
                    </Link>
                  </p>
                </div>
