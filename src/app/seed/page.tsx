      ...
      <div className="w-full max-w-2xl">
        <Card className="avs-card border-0 shadow-2xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Initialize the database with demo users, relationships, and events
              for testing
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-gradient-to-br from-[#E63946] to-[#F77F00] rounded-lg text-white">
                ...
                <p className="text-sm opacity-90">
                  Including admin, matchmaker, and regular users
                </p>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-1 text-sm">
                <div>
                  <strong>Admin:</strong> admin@avs.com / admin123
                </div>
                <div>
                  <strong>Matchmaker:</strong> matchmaker@avs.com /
                  matchmaker123
                </div>
                <div>
                  <strong>User:</strong> suresh.raman@email.com / password123
                </div>
                <div>
                  <strong>Pending:</strong> vijay.mohan@email.com / password123
                </div>
              </div>
            </div>
            ...
            <div className="text-center text-sm text-gray-500">
              <p>
                ⚠️ This will clear all existing data and create fresh demo data.
              </p>
